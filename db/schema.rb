...
ActiveRecord::Schema.define(version: 20171212231243) do
  ...
  add_index "distributions", ["slug"], name: "index_distributions_on_slug", unique: true, using: :btree
